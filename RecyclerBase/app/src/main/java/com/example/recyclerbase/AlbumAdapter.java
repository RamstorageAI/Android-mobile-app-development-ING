...
public class AlbumAdapter extends RecyclerView.Adapter<AlbumAdapter.ViewHolder> {
    ...
    private List<com.example.recyclerbase.AlbumInfo> albumInfoList;
    ...
    public AlbumAdapter(List<com.example.recyclerbase.AlbumInfo> albumInfoList) {
        this.albumInfoList = albumInfoList;
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        com.example.recyclerbase.AlbumInfo album = albumInfoList.get(position);
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        holder.album_thumb.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                com.example.recyclerbase.AlbumInfo data = albumInfoList.get(position);
        ...
        holder.album_thumb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                int position = holder.getAdapterPosition();
                com.example.recyclerbase.AlbumInfo data = albumInfoList.get(position);
                Toast.makeText( v.getContext(),data.getInfo(), Toast.LENGTH_SHORT).show();
            }
        });
        holder.album_title.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                int position = holder.getAdapterPosition();
                com.example.recyclerbase.AlbumInfo data = albumInfoList.get(position);
