...
public class AlbumAdapter extends RecyclerView.Adapter<AlbumAdapter.ViewHolder> {
    ...
    private List<com.example.recyclerviewdemo.AlbumInfo> albumInfoList;
    ...
    public AlbumAdapter(List<com.example.recyclerviewdemo.AlbumInfo> albumInfoList) {
        this.albumInfoList = albumInfoList;
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        com.example.recyclerviewdemo.AlbumInfo album = albumInfoList.get(position);
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        holder.album_thumb.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                com.example.recyclerviewdemo.AlbumInfo data = albumInfoList.get(position);
